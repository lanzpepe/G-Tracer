<div class="ui top fixed collapsible secondary teal inverted large menu">
    <div class="ui container">
            ...
            <div class="menu">
                ...
                <div class="item">
                    ...
                    <div class="menu">
                        ...
                        <a href="{{ route('profiles.index') }}" class="item {{ request()->is('linkedin') ? 'active' : '' }}">{{ __('LinkedIn') }}</a>
                    </div>
                </div>
                <a href="{{ route('jobs.index') }}" class="teal item {{ request()->is('jobs') ? 'active' : '' }}">
                    <i class="briefcase teal icon"></i> {{ __('Course Related Jobs') }}
                </a>
                <a href="{{ route('rewards.index') }}" class="teal item {{ request()->is('rewards') ? 'active' : '' }}">
                    <i class="gifts teal icon"></i> {{ __('Points & Rewards') }}
                </a>
                <a href="{{ route('file_manager') }}" class="teal item {{ request()->is('file_manager') ? 'active' : '' }}">
        ...
        <div class="right floated item notification">
            <a class="ui pointing scrolling top right dropdown circular icon teal button">
                <i class="bell icon"></i>
