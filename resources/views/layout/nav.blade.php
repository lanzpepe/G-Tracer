<div class="ui top attached segment">
    <div class="ui unstackable container secondary menu">
        <div class="item">
            <img src="https://fomantic-ui.com/examples/assets/images/logo.png" alt="">
        </div>
        @if ($admin == config('constants.roles.admin'))
            ...
            <div class="ui simple dropdown teal item">
                {{ __('Institutions') }}<i class="dropdown icon"></i>
                <div class="menu">
            ...
            <div class="ui simple dropdown item">
                {{ __('Academics') }}<i class="dropdown icon"></i>
                <div class="menu">
